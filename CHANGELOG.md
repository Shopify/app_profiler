...
- Require Ruby 3.2.1 or newer (#210)
- Remove the legacy Ruby CI bundle and test Ruby 3.2, 3.3, and 3.4 (#210)
...
- Use Rails' error reporting API if available (#197)
- Eagerly load classes which would be loaded during a request (#198)

## [0.4.0] - 2025-04-10

- Add duration attribute to profile object (#166)

## [0.3.0] - 2025-02-24

- Add support for otel instrumentation (#161)

## [0.2.9] - 2025-02-10

- profile_id improvements (#159)
